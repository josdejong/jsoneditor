...
const _defs = {
  ...
  ko: {
    ...
    auto: '자동',
    appendText: '추가',
    appendTitle: '다음 필드에 "자동" 필드를 추가 (Ctrl + Shift + Ins)',
    appendSubmenuTitle: '추가 필드 유형을 선택하십시오',
    appendTitleAuto: ' "자동" 필드 추가 (Ctrl + Shift + Ins)',
    ascending: '오름차순',
    ascendingTitle: '${type}의 하위 요소를 오름차순으로 정렬',
    actionsMenu: '클릭하여 동작메뉴 열기 (Ctrl + M)',
    cannotParseFieldError: '필드를 JSON으로 해석할 수 없습니다.',
    cannotParseValueError: '값을 JSON으로 해석할 수 없습니다.',
    collapseAll: '모두 접기',
    ...
    duplicateKey: '복제키',
    duplicateText: '복제',
    duplicateTitle: '선택한 필드를 복제합니다. (Ctrl + D)',
    duplicateField: '선택한 필드를 복제합니다. (Ctrl + D)',
    duplicateFieldError: '필드 이름이 중복되었습니다.',
    empty: '비어있음',
    expandAll: '모두 열기',
    expandTitle: '클릭하여 필드를 열거나 닫습니다. (Ctrl + E) \n' +
      'Ctrl + Click으로 모든 자식 요소를 확장 / 축소',
    formatTitle: '적절한 들여쓰기 및 줄바꿈으로 JSON 데이터를 정형화합니다. (Ctrl+I)',
    insert: '삽입',
    insertTitle: '선택한 필드 앞에 새필드를 삽입합니다. (Ctrl + Ins)',
    insertSub: '삽입하려는 필드 유형을 선택',
    object: '객체',
    ok: '확인',
    redo: '다시 실행 (Ctrl + Shift + Z)',
    removeText: '삭제',
    removeTitle: '선택한 필드를 삭제합니다. (Ctrl + Del)',
    removeField: '선택한 필드를 삭제합니다. (Ctrl + Del)',
    repairTitle: 'JSON 복원: JSON의 주석과 JSONP 표기를 지우고 따옴표와 이스케이프 문자를 수정합니다.',
    searchTitle: '필드 또는 값 찾기',
    searchNextResultTitle: '다음 찾기 (Enter)',
    searchPreviousResultTitle: '이전 찾기 (Shift + Enter)',
    selectNode: '노드를 선택해주세요...',
    showAll: '모두보기',
    showMore: '더보기',
    showMoreStatus: '${totalChilds} 개의 항목 중 ${visibleChilds} 개를 표시합니다.',
    sort: '정렬',
    sortTitle: '이 ${type}의 자식 요소를 정렬합니다.',
    sortTitleShort: '정렬',
    sortFieldLabel: '필드:',
    ...
    stringType: '문자열: ' +
      '필드 유형이 값에서 결정되지 않지만, ' +
      '항상 문자열로 반환됩니다. ',
    modeEditorTitle: '에디터 모드 변경',
    modeCodeText: '코드',
    modeCodeTitle: '코드 모드로 전환',
    modeFormText: '양식',
